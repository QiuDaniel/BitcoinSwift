...
// stolen from: https://github.com/kishikawakatsumi/KeychainAccess/blob/master/Lib/KeychainAccess/Keychain.swift
...
extension Status: CustomNSError {
    public static let errorDomain = "com.daniel.BitCore.status.error"
