...
//
/// Code by "Martin R" on StackOverflow: https://stackoverflow.com/a/43193583/1311272
///
...
public extension RIPEMD160 {
    ...
    static func hash(message: String, encoding: String.Encoding = .utf8) -> Data {
        return hash(message: message.toData(encodingForced: encoding))
    }
}
