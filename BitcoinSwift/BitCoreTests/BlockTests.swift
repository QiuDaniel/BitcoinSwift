...
class BlockTests: XCTestCase {
    ...
    func testBlockParse() throws {
        ...
        let block = Block.parse(Data(hex: blockHex))
    ...
    func testTarget() {
        let block = Block.parse(Data(hex: "020000208ec39428b17323fa0ddec8e887b4a7c53b8c0a0a220cfd0000000000000000005b0750fce0a889502d40508d39576821155e9c9e3f5c3157f961db38fd8b25be1e77a759e93c0118a4ffd71d"))
    ...
    func testCheckPoW() {
        let block = Block.parse(Data(hex: "04000000fbedbbf0cfdaf278c094f187f2eb987c86a199da22bbb20400000000000000007b7697b29129648fa08b4bcd13c9d5e60abb973a1efac9c8d573c71c807c56c3d6213557faa80518c3737ec1"))
        XCTAssertTrue(block.checkPoW())
        let block1 = Block.parse(Data(hex: "04000000fbedbbf0cfdaf278c094f187f2eb987c86a199da22bbb20400000000000000007b7697b29129648fa08b4bcd13c9d5e60abb973a1efac9c8d573c71c807c56c3d6213557faa80518c3737ec0"))
